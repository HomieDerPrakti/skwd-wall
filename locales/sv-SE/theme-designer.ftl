...
theme-designer-role-accent-desc = Markeringsramar, aktiva chips, skjutreglage och framhävningar
theme-designer-role-accent-text = Accenttext
theme-designer-role-accent-text-desc = Text på accentfärgade chips och knappar
theme-designer-role-second-accent = Andra accent
theme-designer-role-second-accent-desc = Taggchips, sekundära framhävningar och färgremsan
theme-designer-role-panel = Panel
theme-designer-role-panel-desc = Bakgrunder för inställningar och överlägg
theme-designer-role-panel-text = Paneltext
theme-designer-role-panel-text-desc = Brödtext på paneler och kort
theme-designer-role-panel-alt = Alternativ panel
theme-designer-role-panel-alt-desc = Kortbaksidor, filterraden och diskreta fyllningar
theme-designer-role-panel-raised = Upphöjd panel
theme-designer-role-panel-raised-desc = Kort, rader och upphöjda paneler
theme-designer-role-backdrop = Fond
theme-designer-role-backdrop-desc = Bakgrunden bakom alla paneler
theme-designer-role-outline = Kontur
theme-designer-role-outline-desc = Tunna ramar och avdelare
...
theme-designer-proof-nav-active = Väljare
theme-designer-proof-nav-motion = ◇  Rörelse
theme-designer-proof-nav-playback = ◇  Uppspelning
...
theme-designer-proof-primary-desc = Markering, tangentbordsfokus och huvudåtgärden.
...
theme-designer-proof-status = Den här paletten används bara i förhandsvisningen
theme-designer-proof-roles = 9 roller
theme-designer-proof-eyebrow = Inställningar / tema
theme-designer-proof-title = Förhandsvisning av gränssnittet
theme-designer-editing-role = Redigerar { $role }
theme-designer-proof-section-title = Förhandsvisning av inställningar
theme-designer-proof-section-desc = Förhandsvisningen använder alla nio färger i navigering, kontroller, fält, kort och statusmeddelanden.
...
theme-designer-publish-title = Spara palett
theme-designer-publish-desc = Ge paletten ett namn för att spara båda varianterna. Spara + använd tillämpar varianten som valts ovan.
...
theme-designer-saved-empty = Inga egna paletter än. Ge den aktuella paletten ett namn och spara den för att lägga till den första.
...
theme-designer-role-scrim = Dämpningslager
